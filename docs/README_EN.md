...
<!-- audion:release -->
[![Windows](https://img.shields.io/badge/Windows-10%20%7C%2011-0b6db8?style=flat-square&logo=windows&logoColor=white)](https://audion.dev/downloads/pptx-print-to-pdf-tool) [![Release](https://img.shields.io/github/v/release/Tensionix/audion-pptx-print-to-pdf-tool?style=flat-square&label=release&color=e08a63)](https://github.com/Tensionix/audion-pptx-print-to-pdf-tool/releases/latest) [![Downloads](https://img.shields.io/github/downloads/Tensionix/audion-pptx-print-to-pdf-tool/total?style=flat-square&label=downloads&color=5fd08a)](https://github.com/Tensionix/audion-pptx-print-to-pdf-tool/releases) [![License](https://img.shields.io/github/license/Tensionix/audion-pptx-print-to-pdf-tool?style=flat-square&color=5fd08a&logo=apache&logoColor=white&cacheSeconds=3600)](https://github.com/Tensionix/audion-pptx-print-to-pdf-tool/blob/main/LICENSE)

**Version 1.3.1** · 2026-08-24 · 78.4 MB
...
`SHA-256: 5e17e2873c333d278b45c5059243f5de36c72967b6d670f0cb3765d89326c2c6`
<!-- /audion:release -->
